...
var EXPANSIONS = [
  { id: 'base', name: 'CAIN - Base Rules', version: 'v1.4.5', description: 'Core Rulebook.', descriptionPt: 'Livro de Regras Base.', locked: true },
  { id: 'gff1', name: 'GFF-1', version: 'v1.3.5', description: 'Virtue bond system, 6 mentor NPCs with unique high blasphemies.', descriptionPt: 'Sistema de Vínculos, 6 NPCs mentores com Altas Blasfêmias Únicas.' },
        ...
        EXPANSIONS.map(function(exp) {
          ...
          return '<label class="expansion-item ' + (isLocked ? 'locked' : '') + '">' +
            ...
            '<div class="expansion-info">' +
              '<strong class="exp-name">' + exp.name + '</strong>' +
              '<span class="exp-version">' + exp.version + '</span>' +
              '<p class="exp-desc">' + (currentLang === 'pt' && exp.descriptionPt ? exp.descriptionPt : exp.description) + '</p>' +
            '</div>' +
          '</label>';
        }).join('') +
      '</div>' +
...
var PT_CONTENT = {
  ...
  virtues: {
    ...
    bondAbilities: {
      ...
      order: [
        'Uma vez por cena, após realizar uma ação, descreva a um aliado como ele pode tirar proveito dessa ação. Se ele seguir suas instruções, ganha +1D.',
    ...
    highBlasphemyDescs: {
      justice: 'Você estabelece uma regra da realidade física que afeta tudo em uma área circular ao seu redor, chamada o <b>Tribunal</b>, com um raio igual a CAT+1 [CAT+1:area]. Você pode excluir-se. Quaisquer mudanças feitas ocorrem instantaneamente e persistem dentro da área, mas a área em si não se move. Este poder sempre pode eliminar, destruir ou alterar totalmente seres, objetos ou estruturas mundanas. Seres de vontade forte ou sobrenaturais, como exorcistas ou pecados, podem resistir parcialmente aos seus efeitos, mas os humanos são sempre afetados instantaneamente. Se você sair da área ou a cena terminar, o efeito termina.<br><br>Para usar a Lei, gaste todos os seus pulsos psíquicos restantes (mínimo 1), então complete a frase:<br><br><b>No Tribunal, ____ é/são _____</b><br><br>Você só pode usar palavras da lista abaixo.<br><br>Em seguida, escolha um efeito:<br>\u2022 <b>Conceda até três dados de vantagem</b> (total) a um aliado enquanto o Tribunal estiver ativo. Estes podem ser concedidos um de cada vez ou todos de uma só vez.<br>\u2022 <b>Mate instantaneamente todos os humanos</b> na área ou que entrem na área enquanto o Tribunal estiver ativo.<br>\u2022 <b>Corte um talismã</b> rolando PSIQUE. Este ganha +1D e causa +1 de dano cortante em pelo menos um sucesso.<br>\u2022 <b>Torne algo específico menos difícil ou menos arriscado</b> enquanto o Tribunal estiver ativo.<br><br>Este poder pode facilmente afetar os parâmetros das rolagens enquanto estiver na área e pode até mesmo fazer com que rolagens não sejam necessárias para certas tarefas.<br><br>Efeitos adicionais ficam a critério do Mestre e podem ser improvisados dependendo da narrativa.',
      faith: 'Gaste todos os pulsos psíquicos restantes (mín. 1). Pela duração da cena, você se torna <b>completamente imune a fenômenos psíquicos.</b> Dano físico, como ataques físicos de Pecados, pode afetá-lo normalmente. Você não é afetado por aflições (permanecem suprimidas pela cena). Em troca, pela duração, você <b>não pode usar ou ser afetado por qualquer blasfêmia</b> além desta, incluindo de aliados. Diferente de outros poderes, você não pode encerrar este efeito antes.',
      faith2: 'Esse poder tem a mesma função que <b>Vazio</b>, exceto que é <b>permanente.</b> Ele possui os seguintes efeitos:<br><br>\u2022 Você deixa de <b>poder usar ou ser afetado por blasfêmias.</b><br>\u2022 Você deixa de <b>ganhar, gastar ou interagir com pulsos psíquicos.</b><br>\u2022 Seu pecado retorna para 0. <b>Você deixa de ganhar ou usar pecado ou poder entrar em inundação de pecado por qualquer razão.</b><br>\u2022 Mudanças cosméticas de marcas do pecado persistem, mas não podem ser usadas para qualquer outro efeito.<br>\u2022 Você agora pode ganhar 1d3 de estresse ao invés de gastar um pulso psíquico para ganhar +1D em ações apropriadas usando suas habilidades físicas poderosas.<br>\u2022 Enfrentar pecados com habilidades mundanas <b>deixa de ser difícil</b> por padrão. Além disso, suas habilidades físicas tem ao redor de 1/2 CAT em capacidade. Você pode elevar essa capacidade para uma ação em +1 CAT ganhando 1d3 estresse.<br>\u2022 Você ganha <b>+1 Ferimento Máximo.</b><br>\u2022 Sua expectativa de vida natural se estende em 10d10 anos.',
      charity: 'Você entrelaça sua mente com a de outro em um abraço amoroso. Sem gastar um pulso psíquico, escolha outro exorcista <em>disposto</em>. Pela duração da caçada, ganhe os seguintes efeitos:<br><br>\u2022 Quando um de vocês ganha ou perde <b>estresse</b> ou gasta ou ganha um <b>pulso psíquico</b>, você pode atribuir a perda ou ganho para <b>qualquer um dos dois</b>, independente da distância. Dano, estresse, etc, sobrenaturalmente aparece no corpo do outro. Qualquer coisa transferida dessa forma não pode ser reduzida de forma alguma.<br>\u2022 Você pode se comunicar telepaticamente com essa pessoa a distância extrema. Você também sente qualquer emoção forte que ela sentir reflexivamente, mesmo involuntariamente.<br><br><em>Entretanto:</em><br>\u2022 Quando um de vocês ganha uma <b>aflição</b> ou <b>gancho</b>, ambos ganham essa aflição ou gancho.<br>\u2022 Quando um de vocês ganha <b>pecado</b>, ambos ganham essa quantidade de pecado.<br>\u2022 Se qualquer um de vocês sofrer inundação de pecado ou morte instantânea, esta blasfêmia se quebra pelo resto da missão. Ela não pode ser encerrada de outra forma.<br><br>Após a missão, mesmo se este poder quebrou antes:<br>\u2022 <b>Suas aparências físicas mudam</b> para combinar uma com a outra (cor dos olhos ou cabelo, idade, gênero, altura, forma do corpo ou rosto, etc). Cada um de vocês escolhe uma característica para compartilhar com o outro. O processo leva cerca de três dias e é desagradável<span style="color:#DB1CE6">*</span>.<br>\u2022 <b>Cada um de vocês escolhe um item de agenda da agenda do parceiro</b> e o toma como um item de agenda em negrito para sua própria agenda.<br><br><em style="color:#DB1CE6" class="virtue-food-note">*O uso prolongado deste poder ao longo do tempo levará a uma fusão física e mental que é descrita por Caridade como a forma mais pura de felicidade. Isso não foi verificado pela TEMERITY</em>',
...
var VIRTUES = [
  {
    ...
    highBlasphemy: {
      name: 'Law',
      tags: ['1 Scene', 'Transmute', 'Adjacent'],
      description: 'You set a rule of physical reality that affects everything in a circular area around you, called the <b>Court</b>, with an approximate area of around CAT+1 [CAT+1:area]. You can exclude yourself. Any changes made take place instantly and persist inside the area, but the area itself does not move. This power can always eliminate, destroy, or totally change mundane beings, objects or structures. Strong willed or supernatural beings such as exorcists or sins can partly resist its effects, but humans are always affected instantly. If you exit the area or the scene ends, the effect ends.<br><br>To use Law, spend all your remaining psyche bursts (min 1), then fill in the sentence:<br><br><b>In the Court, ____ is/are _____</b><br><br>You can only use words from the list below.<br><br>Then, choose one effect:<br>\u2022 <b>Grant up to three advantage die</b> (total) to an ally while the Court is active. These can be given out one at a time or all at once.<br>\u2022 <b>Instantly kill all humans</b> in the area or that enter the area while the Court is active.<br>\u2022 <b>Slash a talisman</b> by rolling PSYCHE. This gains +1D and deals +1 slash on at least one success.<br>\u2022 <b>Make something specific less hard, or less risky</b> while the Court is active.<br><br>This power may easily affect the parameters of rolls while in the area, and may make it so rolls are not even required for certain tasks.<br><br>Additional effects are up to the GM and can be improvised depending on the fiction.',
  ...
  },
  {
    ...
    color: '#E3D142',
    compendiumDesc: "Faith is an anomaly both within CAIN and to the world. Born in an Eastern European village in 1672 and forced into a monastic order as a child under suspicion of being cursed, they never aged much past their early twenties and remained in peak physical health, manifesting supernatural strength and constitution. Becoming a hermit about a century after their birth, they were eventually found by an early CAIN and determined to be the only completely graceless and sinless individual in the world.<br><br>Where most humans carry a tiny amount of grace from latent psychic trauma, Faith is a total void. It is theorized this is because they possess an 'anti-blasphemy' that absorbs all others, making them completely immune to psychic phenomena and biologically immortal.<br><br>Faith has the lowest confirmed kills of any virtue. It is rumored CAIN mostly uses them for capture and control missions against rogue binders, at which they are said to be terrifyingly effective.",
    favoriteFood: 'Fast Food, Sweets, Hot Chicken',
    expansion: 'gff1',
    ...
    highBlasphemy: {
      ...
      description: 'Spend all your remaining psyche bursts (min 1). For the duration of the scene, you become <b>completely immune to psychic phenomena.</b> Anything inflicting physical harm, like the physical attacks of Sins, can affect you normally. You cannot be affected by afflictions (though they still remain on you, their abilities are merely suppressed for the scene). In return, for the duration, you <b>cannot use or be affected by any blasphemy</b> other than this one, including those from your allies, and any currently affecting you end. Unlike other powers, you cannot end this effect early.'
    },
    highBlasphemy2: {
      ...
      showAtLevel: 3,
      irreversible: true,
      description: 'This power has the same function as <b>Null</b>, except it is <b>permanent.</b> It has the following effects:<br><br>\u2022 You can <b>no longer use or be affected by blasphemies.</b><br>\u2022 You <b>no longer gain, spend, or interact with psyche bursts.</b><br>\u2022 Your sin resets to 0. <b>You can no longer gain or use sin or can enter sin overflow for any reason.</b><br>\u2022 Cosmetic changes from sin marks persist, but cannot be used for any other effect.<br>\u2022 You can now gain 1d3 stress instead of a psyche burst to gain +1D on any appropriate action by using your powerful physical abilities.<br>\u2022 Fighting sins with mundane abilities is <b>no longer hard</b> by default. In addition, your mundane physical abilities are about 1/2 CAT in capability. You can push this further for an action by +1 CAT by gaining 1d3 stress.<br>\u2022 You gain <b>+1 max injury.</b><br>\u2022 Your natural lifespan extends by 10d10 years.'
    }
  },
  {
    id: 'charity',
    ...
    color: '#DB1CE6',
    compendiumDesc: "A widely feared virtue, Charity stands out immediately due to their unique situation. Charity is functionally the same person occupying two bodies - or alternatively two separate people with identical personalities and physical appearance down to each strand of hair. They share emotions and can react or speak from one body to the other reflexively. This is because Charity's high blasphemy, Entwine, though extremely powerful, forces a merging of its users so that over time they become perfect twins - an amalgam of the two, blended physically and mentally. Since the ability works at any distance, they are often sent apart to different engagements across the globe, though they prefer to work together.<br><br>It is common knowledge that there have been several generations of Charity over the years, since at least the 1850s, and neither body is the original. When one dies, CAIN demands a replacement from a select pool.<br><br><em style=\"color:var(--vc)\">Having bonded with Charity, you have just been added to that list. Congratulations.</em>",
    favoriteFood: 'High Tea, Pork Dumplings',
    expansion: 'gff1',
    ...
    highBlasphemy: {
      name: 'Entwine',
      tags: ['1 hunt', 'Instant'],
      description: 'You entangle your mind with another\'s in a loving embrace. Without spending a psyche burst, choose another <em>willing</em> exorcist. For the duration of the hunt, gain the following effects:<br><br>\u2022 When one of you gains or loses <b>stress</b> or spends or gains a <b>psyche burst</b>, you may assign the loss or gain to <b>either person</b>, no matter the distance. Harm, stress, etc, supernaturally appears on each other\'s bodies. Anything transferred like this cannot be reduced in any way.<br>\u2022 You can telepathically communicate with that person over extreme distance. You also feel any strong emotion they feel reflexively, even involuntarily.<br><br><em>However:</em><br>\u2022 When one of you gains an <b>affliction</b> or <b>hook</b>, both of you gain that affliction or hook.<br>\u2022 When one of you gains <b>sin</b>, you both gain that amount of sin.<br>\u2022 If either of you suffer sin overflow or instant death, this blasphemy breaks for the rest of the mission. It cannot be ended otherwise.<br><br>After the mission, even if this power broke early:<br>\u2022 Both of <b>your physical appearances change</b> to match the other (your eye or hair color, age, gender, height, body or face shape, etc). Each of you chooses a feature to share with the other. The process takes about three days and is unpleasant<span style="color:#DB1CE6">*</span>.<br>\u2022 <b>Each of you pick an agenda item from your partner\'s agenda</b> and take it as a bolded agenda item for your own agenda.<br><br><em style="color:#DB1CE6" class="virtue-food-note">*Prolonged use of this power over time will lead to a physical and mental merge that is described by Charity as the purest form of bliss. This has not been verified by TEMERITY</em>'
    }
  },
  {
    id: 'fortitude',
    ...
    color: '#E30E0E',
    compendiumDesc: "Considered a reserve 'calamity-level elimination weapon' and one of the few exorcists in history judged close to exceeding category 7 in ability, Fortitude is kept on a strict freeze cycle. An extremely volatile and potent fighter, their capacity to execute sins is matched only by their thirst for complete, unbridled destruction. Unleashing Fortitude on a situation is often the equivalent of trying to crack a nut with an industrial hydraulic press.<br><br>Fortitude's high blasphemy, Strength, grants unmatched physical ability, but without proper training its users can literally tear themselves apart. Their notable contempt for human life and unrestrained misanthropy has made them relatively unpopular in the organization's upper ranks, and they have few admirers even among the most jaded junior exorcists.<br><br><em style=\"color:var(--vc)\">There is a special unit within CASTLE's weapons division, the \"Breaking Division\", dedicated to \"tempering\" weapons for Fortitude's use, since without proper materials they cannot withstand the physical forces involved. The specialist research team takes great pleasure in their work, and their findings have greatly advanced CAIN's armaments.</em>",
    favoriteFood: 'Hot Dogs*<br><span class="virtue-food-note">*By CASTLE addendum 3004, the subject is only permitted to consume nutrient paste</span>',
    expansion: 'gff1',
    ...
    highBlasphemy: {
      name: 'Strength',
      tags: ['1 Scene', 'Charm'],
      description: 'A rare mutation of the Amplify blasphemy, this ability allows the very flesh and blood of its wielder to be infused with grace, pushing them past impossible limits. Without proper training, using this blasphemy will cause internal organs to violently burst from the body.<br><br>Spend all your remaining psyche bursts (min 1). For the remainder of the scene, your mundane physical abilities are now equal to CAT and fighting sins with mundane forces is no longer hard by default.<br><br>\u2022 You can push any physical action to CAT+2 instead by gaining 2d3 stress. This could inflict an injury.<br>\u2022 All weapons you use break after use unless specifically tempered. You can temper any weapon between missions by spending 1 scrip per weapon.<br>\u2022 At the end of the scene, you take an <b>injury</b> and become comatose until your group rests. You recover at the start of the rest period and can otherwise rest normally.'
    }
  },
  {
    id: 'hope',
    ...
    color: '#9220F5',
    compendiumDesc: "Hope is among the most valuable assets CAIN possesses. Usually blessed with strong precognitive and telepathic abilities, their capacity to endure the high blasphemy of Veil has been a pillar of the organization's activity for hundreds of years and has let CAIN operate in secret under even the most extreme circumstances.<br><br>Unlike most other blasphemies, Veil's full power can be imbued and passed to other bearers, chosen from a pool of exorcists of extreme mental and cognitive strength. There is a long line of Hopes (the current one is the forty-first) since the organization's founding, and they are usually retired* when the strain of Veil becomes unbearable.<br><br>Because of their important role, Hope is never permitted to leave the orbital station SERAPH, except in extreme circumstances or once a year at Christmas.<br><br><span class=\"virtue-food-note\">*See CASTLE doctrinal note C0447</span><br><br><em style=\"color:var(--vc)\">Used at full capacity, Veil can erase and rewrite the memory of thousands, if not hundreds of thousands, of people for several days at a time. Such use typically kills Hope.</em>",
    favoriteFood: 'Pre-packed meal 402A',
    expansion: 'gff1',
    ...
    highBlasphemy: {
      name: 'Veil',
      tags: ['Instant', 'Long'],
      description: 'Spend all your remaining psyche bursts (min 1) to instantly erase the memory of all humans or exorcists other than you in an up to CAT sized area [CAT:area] centered on a point in long range you can see. Though you can control the size of this area, you cannot exclude anyone from this effect once the area is set.<br><br>All affected become completely insensate for exactly 11 seconds. If an ally acts on this opening, they gain +1D on the action.<br><br>Then, they forget everything they saw and heard for the last <b>77 seconds</b> (including the insensate period). Their brain will work over the damage as if that time never passed (they are effectively \'reset\' to 77 seconds ago). They may be confused by the circumstances: for example they might not be standing where they remember, or holding different items, etc.'
    },
    massMemoryRupture: {
      showAtLevel: 3,
  ...
  },
  {
    ...
    color: '#0786F7',
    compendiumDesc: "Bearer of the powerful blasphemy Shake, Prudence is a friendly, charismatic virtue with a very busy schedule. Besides being a powerful combatant, Prudence plays a vital role both in CAIN's internal structure and in its relationship with mundane governments, thanks to their unique ability to enforce agreements. They hold multiple cover identities, speak several languages, and generally have a very light freeze schedule, as CAIN sends them on long-range, long-duration missions. When appearing in public they are always exceptionally well dressed and eloquent.<br><br>As CAIN's emissary to human governments, their identity has been the subject of speculation among online conspiracy theorists, something the organization has vehemently tried to suppress.<br><br><em style=\"color:var(--vc)\">It is unclear why 'Shake' works on the basis of children's games, but it is rumored to be related to an inherent human desire to play - the 'homo ludens' theory.</em>",
    favoriteFood: 'Nuts',
    expansion: 'gff1',
    ...
    highBlasphemy: {
      name: 'Shake',
      tags: ['1 scene', 'Short'],
      description: 'You may spend all your remaining psyche bursts (min 1) to instantly enforce a game from the list below on yourself and all other humans, sins, or exorcists in range determined by CAT [CAT:distance]. Breaking the rules of the game causes excruciating pain, hemorrhaging, and eventually death.<br><br>As long as the rule applies:<br>\u2022 For you and allies, actions become harder when you must avoid breaking the rule with your actions.<br>\u2022 If through your actions you or an ally intentionally breaks the rule, you take 2d3 stress, which cannot be reduced in any way and could inflict injuries as normal.<br>\u2022 If the target, through their actions, breaks a rule intentionally, they take 1d3 slashes on their execution talisman. Humans are killed instantly. They are aware of this effect.<br>\u2022 You may set up an ally for free, three times, while the rule is active, and without rolling. Describe how you are taking advantage of the rule. Any normal effects of setup apply to these special setup actions, and you can take them without counting as an action in a conflict scene.<br><br>You cannot end this effect early, and it lasts for the scene.',
  ...
  // ─── The Great War expansion ───────────────────────────────────────
  {
    ...
    favoriteFood: 'Beef',
    expansion: 'thegreatwar',
    strictures: 'You cannot follow orders from anyone of equal or lower rank. Roll 0d on any action where you are not leading or did not help plan.',
    strictureIgnoreCost: '2 nonlethal stress',
    likes: ['AFRS', 'Wargames', 'Justice', 'Fortitude'],
    dislikes: ['Prudence', 'Politicians'],
    bondAbilities: [
      { level: 0, description: 'Once per scene, after taking an action, describe to an ally how they can take advantage of that action. If they follow your instructions, they get +1D.' },
      { level: 1, description: 'Gain the Direct blasphemy. You can use it once a hunt.' },
      { level: 2, description: 'You may use Direct an additional time per hunt, but with only one target.' },
      { level: 3, description: 'You may use Direct an additional time per hunt, but you must target yourself in addition to at least one other target.' }
    ],
    highBlasphemy: {
      name: 'Direct',
...
var OFFICIAL_ENEMIES = [
  ...
  { officialId: 'ogre', bestiaryGroup: 'sin', name: 'Ogre', sinTemplate: 'ogre', expansion: 'base',
  ...
  { officialId: 'idol', bestiaryGroup: 'sin', name: 'Idol', sinTemplate: 'idol', expansion: 'base',
  ...
  { officialId: 'hound', bestiaryGroup: 'sin', name: 'Hound', sinTemplate: 'hound', expansion: 'base',
  ...
  { officialId: 'centipede', bestiaryGroup: 'sin', name: 'Centipede', sinTemplate: 'centipede', expansion: 'base',
  ...
  { officialId: 'toad', bestiaryGroup: 'sin', name: 'Toad', sinTemplate: 'toad', expansion: 'base',
  ...
  { officialId: 'lord', bestiaryGroup: 'sin', name: 'Lord', sinTemplate: 'lord', expansion: 'base',
  ...
  // Drifters (Anomalies) — GFF-2 expansion
  {
    ...
    talismanSize: 'medium', talismanSegments: 4, expansion: 'gff2', image: 'img/enemies/drifter_hairy_man.png',
  ...
  },
  {
    ...
    talismanSize: 'short', talismanSegments: 1, expansion: 'gff2', image: 'img/enemies/drifter_skin_light.png',
  ...
  },
  {
    ...
    talismanSize: 'long', talismanSegments: 8, expansion: 'gff2', image: 'img/enemies/drifter_spindley.png',
  ...
  },
  {
    ...
    talismanSize: 'medium', talismanSegments: 4, expansion: 'gff2', image: 'img/enemies/drifter_twin.png',
  ...
  },
  {
    ...
    talismanSize: 'long', talismanSegments: 10, expansion: 'gff2', image: 'img/enemies/drifter_walker.png',
  ...
  },
  {
    ...
    talismanSize: 'medium', talismanSegments: 4, expansion: 'gff2', image: 'img/enemies/drifter_cracked_man.png', images: ['img/enemies/drifter_cracked_man.png', 'img/enemies/drifter_cracked_man_2.png'],
  ...
  },
  {
    ...
    talismanSize: 'long', talismanSegments: 7, expansion: 'gff2', image: 'img/enemies/drifter_dog.png',
  ...
  },
  {
    ...
    talismanSize: 'medium', talismanSegments: 4, expansion: 'gff2', image: 'img/enemies/drifter_neighbor.png', images: ['img/enemies/drifter_neighbor.png', 'img/enemies/drifter_neighbor_2.png'],
  ...
  },
  {
    ...
    talismanSize: 'medium', talismanSegments: 3, expansion: 'gff2', image: 'img/enemies/drifter_worm_body.png',
...
function renderVirtueDetail(virtueId) {
  ...
  // Mass Memory Rupture (Hope only)
  var mmrHtml = '';
  if (v.massMemoryRupture) {
    var mmr = (pt && pt.massMemoryRupture) ? pt.massMemoryRupture : v.massMemoryRupture;
    mmrHtml = '<div class="virtue-high-blas" style="margin-top:var(--space-md)"><strong>' + mmr.title + '</strong><p class="muted">' + mmr.description + '</p>' +
      '<table class="virtue-rupture-table"><tbody>' +
      mmr.tiers.map(function(tier) { return '<tr><td class="rupture-duration">' + tier.duration + '</td><td class="rupture-cost">' + tier.cost + '</td></tr>'; }).join('') +
      '</tbody></table></div>';
  }
